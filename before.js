...
const pages = [
  ...
  },
  {
    ...
    translation: "Нет бога, достойного поклонения, кроме одного лишь Аллаха, у Которого нет сотоварища. Ему принадлежит власть; хвала Ему — Он всё может. Пречист Аллах, хвала Аллаху, нет бога, кроме Аллаха, Аллах велик и нет мощи и силы ни у кого, кроме Аллаха, Высокого, Великого. Господь мой, прости меня!" <br><br> "Если человек проснётся ночью и произнесет эти слова - будет ему прощено, если же он обратится к Аллау с какой-нибудь иной мольбой, то на мольбу его будет дан ответ, если же он совершит омовение и помолится, то молитва его будет принята."
  },
  {
    arabic: " - ",
    transcription: " - ",
...
function updateContent() {
  ...
  document.querySelector('.arabic').textContent = page.arabic;  // Используется textContent для арабского текста
